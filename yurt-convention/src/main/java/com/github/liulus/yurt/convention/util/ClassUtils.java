...
public abstract class ClassUtils {
    ...
    public static Object getFieldValue(Field field, Object obj) {
        ...
        try {
            ...
            throw new ServiceErrorException("获取对象的属性值失败: " + field.getName(), e);
        }
    }
    ...
    public static void setFieldValue(Field field, Object obj, Object value) {
        ...
        try {
            ...
            throw new ServiceErrorException("设置对象的属性值失败：" + field.getName(), e);
        }
    }
    ...
    public static Object invokeMethod(Method method, Object obj, Object... value) {
        ...
        try {
            ...
            throw new ServiceErrorException("Method 调用失败 " + method.getName(), e);
        }
    }
    ...
    public static <T> T newInstance(Class<T> clazz) {
        try {
            ...
            throw new ServiceErrorException("根据class创建实例失败:" + (clazz == null ? "null" : clazz.getName()), e);
        }
    }
    ...
    public static Object newInstance(String clazz) {
        ...
        try {
            ...
            throw new ServiceErrorException("根据class创建实例失败:" + clazz, e);
        }
    }
    ...
    public static Class<?> forName(String name, ClassLoader classLoader) {
        ...
        try {
            ...
            throw new ServiceErrorException("load class error " + name, ex);
        }
    }
